...
const palette_1 = require("../color/palette");
const image_1 = require("../image");
const line_1 = require("../operations/line");
const floodfill_1 = require("../operations/floodfill");
...
exports.paintCanvas = (width, height, palette, fillIndex) => {
    ...
    const click = (e) => {
        ...
        const srgb = rgb_1.createRgb(sr, sg, sb);
        if (srgb === rgb) {
            return;
        }
        const [r, g, b] = rgb;
        floodfill_1.floodFill(cx, cy, width, height, (x, y) => {
            ...
            const crgb = rgb_1.createRgb(cr, cg, cb);
            return crgb === srgb;
        }, (x, y) => {
            const index = (y * width + x) * 4;
...
},{"../color/palette":2,"../color/rgb":3,"../image":4,"../operations/floodfill":7,"../operations/line":8,"../util":9}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const util_1 = require("../util");
const image_1 = require("../image");
...
exports.imageDataToPalette = (imageData) => {
    ...
    for (let y = 0; y < height; y++) {
        for (let x = 0; x < width; x++) {
            ...
            if (used.has(key))
                continue;
            const rgb = rgb_1.createRgb(r, g, b);
            palette.push(rgb);
            used.add(key);
        }
    }
...
exports.splitPaletteToDarkAndLight = (palette) => {
    ...
    const sorted = exports.sortPalette(palette, rgb_1.lumaComparator);
    const d = [];
    const l = [];
...
},{"../image":4,"../util":9,"./rgb":3}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./app":1,"./loaders":6}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const palette_1 = require("./color/palette");
const image_1 = require("./image");
...
},{"./color/palette":2,"./image":4}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
